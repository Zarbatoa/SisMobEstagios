  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            myPadding('Sobre o Sistema:', const EdgeInsets.all(50)),
            Container(
              padding: const EdgeInsets.only(top: 20),
              height: 300,
              child: Image.asset('images/top_pagina_sobre.png', fit: BoxFit.fitHeight)
            ),
            myPadding(texto, const EdgeInsets.all(50))
          ]
        )
      )
    );
